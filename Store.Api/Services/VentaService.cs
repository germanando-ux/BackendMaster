...
namespace Store.Api.Services
{
    public class VentaService : IVentaService
    {
        ...
        public async Task<int> CrearVentaAsync(VentaCreateDto ventaDto)
        {
            try
            {
                Dictionary<int, decimal> productosDb = new(); // Diccionario para almacenar los precios de los productos desde la DB
                ...
                {
                    detalle.PrecioUnitario = productosDb[detalle.ProductId];
                }
